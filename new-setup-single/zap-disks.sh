...
# NVMe partitions used by VMs (OS, bluestore DB, NVMe OSD, inference storage)
# New layout: 1 CP per NVMe drive, workers on 362830/362984, inference on 362935.
VM_NVME=(
    # nvme-362996: control-0 OS + NVMe fast OSD
    ...
    "/dev/disk/by-id/nvme-Netac_NVMe_SSD_250GB_AA20250805250G362984-part4"
    "/dev/disk/by-id/nvme-Netac_NVMe_SSD_250GB_AA20250805250G362984-part5"
    # nvme-362935: inference OS + model storage
