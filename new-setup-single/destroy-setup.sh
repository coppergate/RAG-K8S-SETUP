...
# New layout: 1 CP node per NVMe drive, workers on 362830/362984, inference on 362935.
VM_NVME_PARTITIONS=(
    # nvme-362996: control-0 OS + NVMe OSD
    ...
    "/dev/disk/by-id/nvme-Netac_NVMe_SSD_250GB_AA20250805250G362984-part4"  # worker-3 OS
    "/dev/disk/by-id/nvme-Netac_NVMe_SSD_250GB_AA20250805250G362984-part5"  # worker-3 bluestore DB
    # nvme-362935: inference
    "/dev/disk/by-id/nvme-Netac_NVMe_SSD_250GB_AA20250805250G362935-part1"  # inference-0 OS
    "/dev/disk/by-id/nvme-Netac_NVMe_SSD_250GB_AA20250805250G362935-part2"  # inference model storage
)
