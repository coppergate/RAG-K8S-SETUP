...
export inference_0_mac="${mac_prefix}:A8"
export inference_1_mac="${mac_prefix}:A9"
...
export inference_0_extern_mac="${extern_mac_prefix}:A8"
export inference_1_extern_mac="${extern_mac_prefix}:A9"
